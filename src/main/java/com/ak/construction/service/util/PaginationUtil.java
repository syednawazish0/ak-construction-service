package com.ak.construction.service.util;
...
public final class PaginationUtil {
    ...
    private static final String HEADER_X_PAGE_COUNT = "X-PAGE";
    private static final String HEADER_X_SIZE_COUNT = "X-SIZE";
    ...
    public static <T> HttpHeaders generatePaginationHttpHeaders(UriComponentsBuilder uriBuilder, Page<T> page) {
        ...
        headers.add(HEADER_X_PAGE_COUNT, String.valueOf(pageNumber));
        headers.add(HEADER_X_SIZE_COUNT, String.valueOf(pageSize));
        return headers;
    }
